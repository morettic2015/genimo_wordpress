...
class WPSight_Advanced_Search {
    ...
    public function get_advanced_search_fields($fields_default) {
        ...
        $fields_advanced = array(
            'min' => array(
                'label' => __('Preço (min)', 'wpcasa-advanced-search'),
                'key' => '_price',
                'type' => 'text',
                'data_compare' => '>=',
                'data_type' => 'numeric',
            ...
            'max' => array(
                'label' => __('Preço (max)', 'wpcasa-advanced-search'),
                'key' => '_price',
                'type' => 'text',
                'data_compare' => '<=',
                'data_type' => 'numeric',
            ...
            'orderby' => array(
                'label' => __('Ordenar', 'wpcasa-advanced-search'),
                'type' => 'selecione',
                'data' => array(
                    'date' => __('Data', 'wpcasa-advanced-search'),
                    'price' => __('Preço', 'wpcasa-advanced-search'),
                    'title' => __('Título', 'wpcasa-advanced-search')
                ),
                'default' => 'date',
                'advanced' => true,
                'class' => 'width-1-4',
            ...
            'order' => array(
                ...
                'type' => 'select',
                'data' => array(
                    'asc' => __('a-z', 'wpcasa-advanced-search'),
                    'desc' => __('z-a', 'wpcasa-advanced-search')
                ),
                'default' => 'desc',
                'advanced' => true,
                'class' => 'width-1-4',
