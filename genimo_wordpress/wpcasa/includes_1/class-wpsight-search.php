...
class WPSight_Search {
    ...
    public static function get_search($args = array(), $search_fields = array()) {
        ...
        $defaults = array(
            ...
            'advanced' => '<span class="listings-search-advanced-toggle">' . __('Busca Avançada', 'wpcasa') . '</span>', // Set (bool) false to hide advanced search
            'reset' => '<span class="listings-search-reset">' . __('Limpar Filtros', 'wpcasa') . '</span>', // Set (bool) false to hide reset button
        );
    ...
    public static function get_search_fields($fields = array()) {
        ...
        $defaults = array(
            'keyword' => array(
                'label' => __('Palavra chave ou código do imóvel', 'wpcasa') . '&hellip;',
                'type' => 'text',
                'class' => 'width-3-4',
                'priority' => 10
            ),
            'submit' => array(
                'label' => __('Buscar', 'wpcasa'),
                'type' => 'submit',
                'class' => 'width-1-4',
                'priority' => 20
            ),
            'offer' => array(
                'label' => __('Modalidade', 'wpcasa'),
                'key' => '_price_offer',
                'data' => wpsight_offers(),
                'type' => 'select',
                'data_compare' => '=',
            ...
            'location' => array(
                'data' => array(
                    ...
                    'taxonomy' => 'location',
                    'show_option_none' => __('Localização', 'wpcasa'),
                    'option_none_value' => '',
                    'hierarchical' => 1,
                    'orderby' => 'ID',
                    'order' => 'ASC'
            ...
            'listing-type' => array(
                'data' => array(
                    ...
                    'show_option_none' => __('Tipo do Imóvel', 'wpcasa'),
                    'option_none_value' => '',
                    'hierarchical' => 1,
                    'orderby' => 'ID',
                    'order' => 'ASC'
