		...
		if( $post_type == 'nf_sub' && isset ( $_REQUEST['post_status'] ) && $_REQUEST['post_status'] == 'all' ) {
			...
			<script type="text/javascript">
				jQuery(document).ready(function() {
					...
					jQuery('<option>').val('genimo').text('Enviar para o Genimo').appendTo("select[name='action']");
					jQuery('<option>').val('genimo').text('Enviar para o Genimo').appendTo("select[name='action2']");
					<?php
