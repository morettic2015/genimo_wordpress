<form id="frmSearchForm" method="get"<?php echo $args['id']; ?> action="<?php echo esc_url($args['action']); ?>" class="<?php echo sanitize_html_class($args['class']); ?> <?php echo sanitize_html_class($args['orientation']); ?>">
