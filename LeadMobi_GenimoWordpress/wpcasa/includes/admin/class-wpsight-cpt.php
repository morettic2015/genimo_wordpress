...
class WPSight_Admin_CPT {
    ...
    public function columns($columns) {
        ...
        $columns["listing_offer"] = __('Modalidade', 'wpcasa');
        $columns["listing_id"] = __('ID', 'wpcasa');
        $columns["listing_title"] = __('Imóvel', 'wpcasa');
        $columns["listing_price"] = __('Preço', 'wpcasa');
        $columns["listing_posted"] = __('Publicação', 'wpcasa');
    ...
    public function post_updated_messages($messages) {
        ...
        $messages[$post_type] = array(
            ...
            9 => sprintf(__('%s scheduled for: <strong>%1$s</strong>. <a target="_blank" href="%2$s">Preview</a>', 'wpcasa'), $wp_post_types[$post_type]->labels->singular_name, date_i18n(__('M j, Y @ G:i', 'wpcasa'), strtotime($post->post_date)), esc_url(get_permalink($post_ID))),
