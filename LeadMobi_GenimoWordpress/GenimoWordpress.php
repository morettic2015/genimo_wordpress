    ...
    public static function syncProperty($idCompany, $idProperty) {
        ...
        if ($idPropertyDB > 0) {
            ...
            DB::insert('wp_posts', array(
                ...
                'post_date' => $date, //Just now its new
                'post_date_gmt' => $date, //just now its new
                'post_content' => utf8_decode(self::replaceSearch($obj->property->dsPropertySite)), //Get as String UTF 8
      ...
      //  echo "<pre>";
       // var_dump($images);
        ...
        foreach ($images as $img) {
            ...
            echo $img->flSpotlight. "---";
            
            if ($counter > 0) {


                if (intval($img->flSpotlight) == 1) {
